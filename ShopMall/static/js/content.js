$(function () {
    ...
    function Magnifier() {
        ...
        //默认选中第一张
        $(".allImg li").eq(0).addClass("current");
...
function code() {
    ...
    $('#yanzheng').attr('src', "/forget_pwd/?" + timestamp)
}
...
$(document).ready(
    $.ajax({
        ...
        success: function (data, status, xhr) {
            ...
            if(data!='请登陆'){
                //attr添加属性
                $('#state').attr('href','http://127.0.0.1:8000/home/my_center');
            }
            // console.log(data)
...
// 购物车删除
function gwc_delete(id) {
    $.ajax({
        url:'http://127.0.0.1:8000/home/delcar',
        type:'get',
        data:{p:id},
        dataType:'json',
        success: function (data, status, xhr) {
